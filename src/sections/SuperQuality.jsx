  ...
  return (
    <section id="about-us" className="flex justify-between items-center max-lg:flex-col gap-10 w-full max-container">
      <div className="flex flex-1 flex-col">
        <h2 className="text-4xl capitalize font-bold lg:max-w-lg dark:text-white">
        <span className="text-coral-red">سامانه</span>  <span className="">ارسال صورتحساب</span> 
        </h2>

        <p className="mt-4 lg:max-w-lg info-text dark:text-gray-400">سامانه ارسال صورتحساب الکترونیک با هدف تسهیل فرآیندهای مالی و افزایش دقت در مدیریت و ثبت و ارسال صحیح صورتحساب‌ها، طراحی و توسعه یافته است و با طراحی کاربرپسند خود، باعث کاهش خطاهای انسانی و پیچیدگی و زمان بر بودن فرآیند ارسال صورتحساب شده است. </p>
